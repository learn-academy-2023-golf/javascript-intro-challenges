...
// console.log("LeDarrien Thompson".length); // 18

const LT = "LeDarrien Thompson";
// console.log(LT.length); // 18


// Write the code that will log whether your string includes the letter "e"?

// console.log(LT.includes("e")); // true

// Write the code that will log the character at the first index of the string.

// console.log(LT.charAt(0)); // L

// Write the code that will log the string in all uppercase letters.

// console.log(LT.toUpperCase()); // LEDARRIEN THOMPSON
...
// Write the code that will log the whole number 
// remainder of theAnswer when divided by 3.
